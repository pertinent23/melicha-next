    ...
    return (
        <Fragment>
            ...
            <div className="container-fluid main-container position-relative h-100 d-none">
                ...
                >
                    <div className="container-fluid table my-5 mx-0 px-3 py-3 border rounded">
                        <div className="row">
                            <div className="col-9 d-flex flex-column justify-content-center">
                                ...
                                <div className="row pb-5">
                                    <div className="col d-flex flex-row justify-content-center">
                                        <div className="main-item box-item border rounded d-flex justify-content-center align-items-center position-relative">
...
DradAndDrop.scripts = [ 
    '/script/extends/drag-and-drop.js' 
];