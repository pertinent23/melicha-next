...
export const page = 'admin.add.game.crossed.word';
export default function AddCrossedWord( ) {
    const 
        route = useRouter(),
        url = route.pathname;
    return (
        <Fragment>
            ...
            <div className="container-fluid main-container h-100 d-none px-0">
                <div className="container-fluid px-0 d-flex flex-column pb-5">
                    ...
                    <div className="container px-3 py-4 mt-4"> Entrer les mots à remplir. </div>
                    <Choice />
